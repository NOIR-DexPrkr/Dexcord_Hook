      ...
      >
        ...
        <div className="footer-right" style={{ display: 'flex', alignItems: 'center', gap: '2rem', flexWrap: 'wrap', justifyContent: 'center' }}>
          ...
          <div style={{ display: 'flex', gap: '1rem', alignItems: 'center' }}>
            <a href="https://dexnr.pages.dev/" title={t.foot_website} style={{ color: 'var(--text-muted)', transition: 'var(--transition)' }} className="social-link">
              <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10"/><line x1="2" y1="12" x2="22" y2="12"/><path d="M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z"/></svg>
            </a>
            <a href="https://discord.gg/cua9Qvfvz5" title={t.foot_discord} style={{ color: 'var(--text-muted)', transition: 'var(--transition)' }} className="social-link">
            ...
            <a href="https://www.buymeacoffee.com/consejosnoiroom" title={t.foot_donations} style={{ color: 'var(--text-muted)', transition: 'var(--transition)' }} className="social-link">
